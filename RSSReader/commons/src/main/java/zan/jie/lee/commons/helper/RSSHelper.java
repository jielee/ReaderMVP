package zan.jie.lee.commons.helper;
 ...
 */
public class RSSHelper extends DefaultHandler {
    ...
    public static List<News> loadRss(InputStream input, final String encode) {
    ...
    public void startElement(String uri, String qname, String localName, Attributes attributes) throws SAXException {
        ...
        if ("item".equalsIgnoreCase(localName)) {
            ...
            if(attributes.getValue("url").indexOf("mp4")== -1){
